#This is the Classifier Script without NLTK Dependency.
...
if __name__ == "__main__":
    ...
    num_label_df = wanted_words_df.withColumn("label", func_num_label(wanted_words_df["Annotation"])) #Change second param to label

    selected_cols_df = num_label_df.select(num_label_df['Wanted'], num_label_df['label']) #Change second param to label
    temp_df = selected_cols_df.withColumnRenamed("Wanted", "text")
